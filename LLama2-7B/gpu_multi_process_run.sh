...
echo "In gpu_multi_process_run.sh script"
export NNODES=$NNODES
export NODE_RANK=$RANK
export JAX_COORDINATOR_ADDRESS=$MASTER_ADDR
export NODE_RANK=$RANK
export LD_LIBRARY_PATH=$NCCL_LIB_DIR:/usr/local/cuda/lib64:$LIBRARY_PATH:

export GPUS_PER_NODE=$GPUS_PER_NODE
export JAX_COORDINATOR_PORT=$JAX_COORDINATOR_PORT

echo "Coordinator Address $JAX_COORDINATOR_ADDRESS"
echo "Coordinator Address $JAX_COORDINATOR_PORT"
...
echo "Coordinator Address $JAX_COORDINATOR_IP"
